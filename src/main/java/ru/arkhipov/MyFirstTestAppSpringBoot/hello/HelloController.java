...
public class HelloController {
    ...
    public String updateArrayList(@RequestParam(value = "value", defaultValue = " ") String s) {
        if (array.isEmpty()) {
            array = new ArrayList<>();
        }
        array.add(s);
    ...
    public String updateHashMap(@RequestParam(value = "value", defaultValue = " ") String s) {
        if (hashMap.isEmpty()) {
            hashMap = new HashMap<>();
        }
        hashMap.put(s, s);
